...
def test_has_file():
    print("----- HAS FILE -----")
    print("Expected not to have files:")
...
def test_positive():
    ...
    for person, nationality in [("Arnold Schwarzenegger", "Austria"), ("Michael Jackson", "France"), ("Patrick Burns (businessman)", "Bulgaria")]:
        print(person, nationality, generalFeature.is_positive(person, nationality, definitions.TYPE_NATIONALITY))
    ...
    for person, profession in [("Arnold Schwarzenegger", "Actor"), ("Michael Jackson", "Politician"), ("Patrick Burns (businessman)", "Violist")]:
        print(person, profession, generalFeature.is_positive(person, profession, definitions.TYPE_PROFESSION))
...
def test_negative():
    ...
    for person, nationality in [("Arnold Schwarzenegger", "Austria"), ("Michael Jackson", "France"), ("Patrick Burns (businessman)", "United States of America")]:
        print(person, nationality, generalFeature.is_negative(person, nationality, definitions.TYPE_NATIONALITY))
    ...
    for person, profession in [("Arnold Schwarzenegger", "Actor"), ("Michael Jackson", "Dancer"), ("Maurice Prendergast", "Artist")]:
        print(person, profession, generalFeature.is_negative(person, profession, definitions.TYPE_PROFESSION))
