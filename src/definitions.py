...
REGRESSION_MODEL_NATIONALITY_PATH = os.path.join(DATA_DIR, "regression", "regression_nationality_model.txt")
REGRESSION_MODEL_PROFESSION_PATH = os.path.join(DATA_DIR, "regression", "regression_profession_model.txt")
